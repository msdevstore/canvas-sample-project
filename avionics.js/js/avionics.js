...
Avionics.PrimaryFlightDisplay = function(canvas){
	...
	this.pitchLineSpan = Math.floor(canvas.width / 10.0) //Lind no bi
	this.pitchLineWidth = Math.floor(canvas.height / 150.0)    //Lind duGyoi

	this.pitchSpacing = Math.floor(canvas.height / 10.0) // //Lind space
